import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, M as useComposedRefs, R as React, E as cn, $ as reactDomExports, a0 as useAddContact, G as Phone, Z as Mail, I as Input, B as Button, z as ue } from "./index-S-wpKozw.js";
import { u as useControllableState, P as Primitive, b as useId, c as composeEventHandlers, e as Presence, a as createContextScope, l as useLayoutEffect2, d as useCallbackRef, f as Portal$1, h as hideOthers, i as useFocusGuards, R as ReactRemoveScroll, F as FocusScope, D as DismissableLayer, j as createSlot } from "./index-CvcSwpNX.js";
...
import { a as useSize, u as usePrevious } from "./index-DOGgJdYB.js";
...
const FAQ_ITEMS = [
  {
    ...
    answer: "We deliver across Delhi NCR, including Delhi, Gurugram, Noida, Faridabad, and Ghaziabad. We are rapidly expanding to more cities. Enter your pincode at checkout to check availability in your area."
  },
  {
    question: "How fresh are your products?",
    answer: "All Yadav Dairy products are sourced fresh daily from our network of trusted dairy farms. Milk is procured, pasteurized, and dispatched within 6 hours of milking. Products are delivered within 24 hours of packaging."
  },
  {
    question: "What is your return policy?",
    answer: "We offer a 100% freshness guarantee. If you receive a product that does not meet our quality standards, contact us within 2 hours of delivery and we will arrange a replacement or full refund — no questions asked."
  },
  {
    question: "Can I change my order?",
    answer: "Orders can be modified or cancelled within 30 minutes of placement. After that, orders are processed for dispatch. Please call our support line at +91-9801234567 immediately if you need to make changes."
  },
  {
    question: "What payment methods do you accept?",
    answer: "We accept Cash on Delivery (COD), UPI, Net Banking, and all major debit/credit cards. All online transactions are secured with 256-bit SSL encryption."
  },
  {
    question: "Do you offer subscriptions?",
    answer: "Yes! Subscribe to daily or weekly delivery plans for milk, curd, paneer, and more. Subscribers enjoy 10% off every order and priority delivery slots. Set up your subscription from your profile page."
  }
];
const INITIAL_FORM = {
  name: "",
...
function ContactPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (form.message.trim().length < 10) {
      ue.error("Message must be at least 10 characters.");
      return;
    }
    const payload = {
      name: form.name.trim(),
    ...
    try {
      ...
      ue.success("Message sent! We will reply within 24-48 hours.");
  ...
  const handleLiveChat = () => {
    ue.info("Live chat coming soon!");
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-card border-b py-10 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto text-center animate-fade-in", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-5xl mb-3", children: "🤝" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl md:text-4xl font-display font-bold text-foreground mb-2", children: "Contact Us" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-lg max-w-md mx-auto", children: "We are here to help. Reach out and our team will get back to you promptly." })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto px-4 py-10 space-y-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "animate-slide-up", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "card-hover border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-5 flex flex-col items-center text-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "w-5 h-5 text-primary" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-foreground", children: "Phone" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                ...
                children: "+91-9801234567"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground mt-1 flex items-center justify-center gap-1", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "card-hover border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-5 flex flex-col items-center text-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-full bg-accent/10 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "w-5 h-5 text-accent" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-foreground", children: "Email" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                ...
                children: "support@yadavdairy.com"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground mt-1 flex items-center justify-center gap-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "w-3 h-3" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "card-hover border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-5 flex flex-col items-center text-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-full bg-chart-3/10 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "w-5 h-5 text-chart-3" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-foreground", children: "Location" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground leading-snug", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "animate-slide-up", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-8 items-start", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "shadow-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "pb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "font-display text-xl flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Send, { className: "w-5 h-5 text-accent" }),
              "Send us a Message"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Fill in the form and we will get back to you within 24–48 hours." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "space-y-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                ...
                children: submitMutation.isPending ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-4 h-4 border-2 border-accent-foreground/30 border-t-accent-foreground rounded-full animate-spin" }),
                  "Sending..."
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-xl text-foreground mb-1", children: "Frequently Asked Questions" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Quick answers to common questions about Yadav Dairy." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Accordion,
            {
              ...
              children: FAQ_ITEMS.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                AccordionItem,
                {
                  value: item.question,
                  className: "border border-border rounded-lg px-4 bg-card",
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionTrigger, { className: "font-medium text-sm text-foreground hover:no-underline py-3", children: item.question }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionContent, { className: "text-sm text-muted-foreground pb-3 leading-relaxed", children: item.answer })
                  ]
                },
                item.question
              ))
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "bg-muted/40 rounded-2xl p-6 md:p-8 flex flex-col md:flex-row items-center justify-between gap-4 animate-fade-in", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-lg text-foreground", children: "Need immediate help?" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Call us directly for urgent order or delivery issues." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "tel:+919801234567", "data-ocid": "contact-call-cta", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
              variant: "outline",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { className: "btn-accent gap-2", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute right-16 bg-card text-foreground text-xs font-medium px-2 py-1 rounded-md border border-border shadow-md opacity-0 group-hover:opacity-100 transition-smooth whitespace-nowrap pointer-events-none", children: "Chat with us" })
        ]
      }
    )
  ] });
